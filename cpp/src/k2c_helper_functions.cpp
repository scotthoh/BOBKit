 ...
 */
void k2c_helper_functions::k2c_matmul(float * C, const float * A, const float * B, const size_t outrows,
 ...
 * :param innderdim: number of cols of A and rows of B
 */
void k2c_helper_functions::k2c_affine_matmul(float * C, const float * A, const float * B, const float * d,
 ...
 */
void k2c_helper_functions::k2c_dot(k2c_tensor* C, const k2c_tensor* A, const k2c_tensor* B, const size_t * axesA,
 ...
 * :param b: bias tensor.
 */
void k2c_helper_functions::k2c_bias_add(k2c_tensor* A, const k2c_tensor* b) {
...
size_t k2c_helper_functions::k2c_sub2idx(const size_t * sub, const size_t * shape, const size_t ndim) {
...
void k2c_helper_functions::k2c_idx2sub(const size_t idx, size_t * sub, const size_t * shape, const size_t ndim) {
...
float* k2c_helper_functions::k2c_read_array( const char* layername,const size_t array_size  ,const char* filename) {
...
float* k2c_helper_functions::k2c_zero_array(const size_t array_size){
	float* ptr = (float*) malloc(array_size * sizeof(float));
	//*ptr={0};
