...
runcyc::runcyc(int nfrag, clipper::Resolution resol, clipper::MiniMol &mol_wrk,
		...
		int startstep, int endstep,clipper::String &mollog,Ca_find cafind,std::map<std::pair<clipper::String,clipper::String>, clipper::MMonomer> &seqscore, bool saveseqscore ) {
