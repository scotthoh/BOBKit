...
void add_model_tidy(nb::module_ &m) {
  ...
  model_tidy
      .def(nb::init<double, int, String, bool>(), nb::arg("rmsd") = 1.0,
           nb::arg("nmin") = 12, nb::arg("newrestype") = "ALA",
           nb::arg("verbose") = false)
      .def("tidy", &ModelTidy::tidy, nb::arg("mol"), nb::arg("mol_mr"),
           nb::arg("seq"), "Tidy model.")
      .def_static("chain_renumber", nb::overload_cast<MiniMol &, const MMoleculeSequence &>(
      ...
      //                &ModelTidy::chain_renumber),
      //            nb::arg("mol"), nb::arg("seq"), "Renumber residues in chain.")
      .def_static("chain_assign", &ModelTidy::chain_assign, nb::arg("mol"),
                  nb::arg("mol_mr"), nb::arg("seq_nums"), nb::arg("rmsd"),
                  nb::arg("nmin"), "Assign chain fragments to MR model.")
      .def_static("chain_move", &ModelTidy::chain_move, nb::arg("mol"),
                  nb::arg("mol_mr"), nb::arg("chnnums"))
      .def_static("sequence_correct", &ModelTidy::sequence_correct,
                  nb::arg("mol"), nb::arg("seq"), nb::arg("seqnums"),
                  nb::arg("newrestype"), "Correct the sequence.")
      .def_static("sequence_count", &ModelTidy::sequence_count, nb::arg("mol"),
