...
void declare_buccaneer_log(py::module &m) {
  py::class_<BuccaneerLog>(m, "Log")
      ...
      .def("log",
           static_cast<void (BuccaneerLog::*)(const clipper::String &,
                                              const clipper::MiniMol &, bool)>(
               &BuccaneerLog::log),
           py::arg("id"), py::arg("mol"), py::arg("view"))
      .def("log",
           static_cast<clipper::String (BuccaneerLog::*)(
               const clipper::MiniMol &, const clipper::MiniMol &,
               const clipper::MMoleculeSequence &)>(&BuccaneerLog::log),
