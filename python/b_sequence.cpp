...
void declare_ca_sequence(py::module &m) {
  ...
  casequence
      ...
      .def( "__call__", &Ca_sequence::operator(), py::arg( "mol" ), py::arg( "xmap" ),
            py::arg( "llktargets" ), py::arg( "seq" ), "Sequence Ca chains using density." )
      ...
      .def_static( "prepare_score", &Ca_sequence::prepare_score, py::arg( "mm" ), py::arg( "xmap" ),
                   py::arg( "llksample" ), "Cache scores in residue properties." )
      ...
      .def_static( "sequence_overlap", &Ca_sequence::sequence_overlap, py::arg( "seq1" ),
                   py::arg( "seq2" ),
                   "Return fraction of first sequence which overlaps the second." )
      .def_static( "sequence_similarity", &Ca_sequence::sequence_similarity, py::arg( "seq1" ),
                   py::arg( "seq2" ), "Return fraction of sequenced residues which match" )
      .def_static( "sequence_combine", &Ca_sequence::sequence_combine, py::arg( "seq" ),
                   py::arg( "reliability" ),
                   "Combine multiple non-conflicting sequence alignments." )
      .def_static( "sequence_score", &Ca_sequence::sequence_score, py::arg( "scores" ),
                   py::arg( "subseq" ),
                   "Return highest scoring subsequence matching the given "
                   "sequence to the supplied LLK scores." )
      .def_static( "sequence_align", &Ca_sequence::sequence_align, py::arg( "scores" ),
                   py::arg( "seq" ),
                   "Perform sequence alignment between the given chain scores "
                   "and the given sequence." )
      .def_static( "sequence_match", &Ca_sequence::sequence_match, py::arg( "scores" ),
                   py::arg( "seq" ),
                   "Return a scored list of sequence matches between a set of "
                   "LLK scores and available sequence ranges." )
      .def_static( "sequence_chain", &Ca_sequence::sequence_chain, py::arg( "chain" ),
                   py::arg( "seq" ),
                   "Sequence a chain based on the map LLK target, and available "
                   "sequence ranges." )
      .def_static( "sequence_apply", &Ca_sequence::sequence_apply, py::arg( "chain" ),
                   py::arg( "seq" ), py::arg( "flags" ),
                   "Apply matching sequence to chain, taking account any "
                   "existing sequence." )
      .def_static( "sequence", &Ca_sequence::sequence, py::arg( "chain" ), py::arg( "seq" ),
                   py::arg( "reliability" ),
      ...
      .def_static( "set_prior_model", &Ca_sequence::set_prior_model, py::arg( "mol" ),
                   "Set prior model." )
